...
%INITIALISE_HERMITE_TRANSFORM_BUNCK
...
% See the appendix of "Bunck A fast algorithm for evaluation of normalized 
% Hermite functions", BIT, 2009, and Webb--Maierhofer 2026.
...
for j = 3:N
    ...
    scale = arrayfun(@(v) (v < 10) * 1 + (v >= 10) * (1/max(1,abs(v))), abs(hj));
