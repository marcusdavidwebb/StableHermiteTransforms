...
try
load("data/numerical_eval_N_10-150.mat")

%% Plot 1: Assembly time

figure(1)
semilogy(N_save, time_direct,'v-','linewidth',2, 'MarkerSize',10,'Color','#7e2f8e','MarkerFaceColor','white')
hold on
...
legend('Direct approximation', 'New approximation','Interpreter','latex', 'FontSize', 20,'Position',[0.27 0.8 0.1 0.1])
grid on
hold off
...
set(gca,'FontSize',16)
xlabel('$N$','Interpreter','latex', 'FontSize', 22)
ylabel('$\|T-DQ\|$','Interpreter','latex', 'FontSize', 22)
...
figure(3)
semilogy(N_save, error_fn_approx_direct,'v-','linewidth',2, 'MarkerSize',10,'Color','#7e2f8e','MarkerFaceColor','white')
hold on
...
%% Figure 4
figure(4)
semilogy(N_save, cond_Hforward,'v-','linewidth',2, 'MarkerSize',10,'Color','#7e2f8e','MarkerFaceColor','white')
hold on
...
set(gca,'FontSize',16)
xlabel('$N$','Interpreter','latex', 'FontSize', 22)
legend('cond(Hforward)',"cond(Q'.*(1./d)')",'Interpreter','latex', 'FontSize', 20,'Position',[0.24 0.8 0.1 0.1])
grid on
hold off
set(gcf, 'Position',  [100, 100, 700, 600])
